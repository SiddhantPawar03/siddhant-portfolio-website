...
const Hero = () => {
  return (
    <section className="py-12 xl:py-12 m:h-[44vh] h-[84vh] xl:pt-28 bg-hero bg-no-repeat bg-cover bg-bottom dark:bg-none">
      <div className="conatiner mx-auto">
        <div className="flex gap-x-8 justify-around xl:p-12">
